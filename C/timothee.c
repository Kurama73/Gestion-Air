...
void afficherVolHeure (struct Vol tableau_vols[], int ,int );
...
int main()
{
    ...
    do {
        ...
        printf("3- Afficher les vols en fonction de l'heure\n");
        printf("4- Afficher les vols en fonction de la destination\n");
        printf("5- Afficher les vols en fonction de la compagnie\n");
        printf("Choix : ");
        scanf("%d", &choix);
        ...
        switch (choix) {
            ...
            case 3:
                ...
                printf("Entrez l'heure de decollage : ");
                int heure;
                scanf("%d", &heure);
            ...
            case 4:
                // Afficher les destiantion d'un vol
